...
def lambda_handler(event, context):
    ...
    departure_date = event.get('departureDate', '2024-12-20')
    ...
    try:
        ...
        for option in travel_options:
            ...
            for flight_info in option['flights']:
                ...
                scheduled_departure = flight_info['departure']['scheduledTime']
                scheduled_arrival = flight_info['arrival']['scheduledTime']
                local_scheduled_departure = flight_info['departure']['localScheduledTime']
                local_scheduled_arrival = flight_info['arrival']['localScheduledTime']
                utc_offset_departure = flight_info['departure']['airport']['utcOffset']
                utc_offset_arrival = flight_info['arrival']['airport']['utcOffset']
                ...
                flight_info_dict = {
                    ...
                    "local_scheduled_departure": local_scheduled_departure,
                    "utc_offset_departure": utc_offset_departure,
                    "scheduled_arrival": scheduled_arrival,
                    "local_scheduled_arrival": local_scheduled_arrival,
                    "utc_offset_arrival": utc_offset_arrival,
