...
resource "aws_api_gateway_integration" "accessibility_request_get" {
  ...
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/accessibilityRequest"
}
...
resource "aws_api_gateway_integration" "ancillary_search_get" {
  ...
  integration_http_method = "GET"
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/searchAncillary"
}
...
resource "aws_api_gateway_integration" "create_reservation_post" {
  ...
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/createReservation"
}
...
resource "aws_api_gateway_integration" "flight_selection_get" {
  ...
  integration_http_method = "GET"
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/flightSelect"
}
...
resource "aws_api_gateway_integration" "low_fares_get" {
  ...
  integration_http_method = "GET"
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/lowFares"
}
...
resource "aws_api_gateway_integration" "payment_methods_get" {
  ...
  integration_http_method = "GET"
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/paymentMethods"
}
...
resource "aws_api_gateway_integration" "payment_reservation_post" {
  ...
  integration_http_method = "POST"
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/paymentReservation"
}
...
resource "aws_api_gateway_integration" "seat_selection_get" {
  ...
  integration_http_method = "GET"
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/seatSelection"
}
...
resource "aws_api_gateway_integration" "voucher_code_get" {
  ...
  integration_http_method = "GET"
  type        = "HTTP"
  uri         = "https://${aws_api_gateway_rest_api.website_dev.execution_arn}/dev/v1/voucherCode"
}
